...
## To demonstrate use of Structures and Union in C
...
### 2.Create a structure employee (id, name, salary) salary). Accept details of n employees and write a menu driven program to perform the following operations. Write separate functions for the different options. 
###### i) Search by name
###### ii) Search by id
###### iii) Display all
...
### 3. Create a structure to accept details for n books and write a menu driven program for the following:
