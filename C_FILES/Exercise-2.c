...
/*1. Write a menu driven program to perform the following operations on strings using standard library functions : Length
Length
Copy
Concatenation
Compare
...
/*4.For the following standard functions, write corresponding user defined functions and write a menu driven program to use them.

Strlen, strrev, strupr, strlwr, strcat, strcmp*/
...
/*7. Write a function which displays a string in the reverse order.(Use recursion)7. Write a function which displays a string in the reverse order.(Use recursion)*/
//Program
#include <stdio.h>
            int main()
            {
