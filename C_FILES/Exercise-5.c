...
/*1. Write a program to accept two filenames as command line arguments. Copy the
...
/*2. Write a program to accept a filename as command line argument and count the number
of words, lines and characters in the file.*/
...
/*3. Write a program to accept details of n students (roll number, name, and percentage) and
write it to a file named “student.txt”. Ac cept roll number from the user and search the
student in the file. Also display the student details having the highest percentage*/
