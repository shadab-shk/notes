...
/*output
Before Swapping x=14 y=15 After Swapping x=15 y=14
*/
...
/* Output
Enter two numbers : 3 4 Both numbers are Not Equal
*/
...
Enter first number: 100 Enter second number: 200 Maximum number is: 200
*/
